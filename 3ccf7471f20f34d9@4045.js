...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["lives.jpg",new URL("./files/5a158192f9c4da67fc3dd88ed069a572d22e5801b926b9fe057d7981452ff3c760e9b7314edb40bc0a4568e2239e4049bb0b6f202f64c9d809b139d5a263a047",import.meta.url)],["score.jpg",new URL("./files/0ce1c61520791604b016d21e3bf100a3969f689975c682fc94edb758aebf4eda4200a5f725f6ef5575bb1abe50f11a5567e363904ed36363d3f46a60303b9d9b",import.meta.url)],["text.png",new URL("./files/aa27bf6437aa8f708034618e5abd5db96d5a6317622db55914a146e3dda6cae2ba853e70f6501585d654d71a7c52a893a451f01f53640231917a7344b8bf19ec",import.meta.url)],["live.jpg",new URL("./files/033193ddcbb5f0d2d21781130d8d1c0cb1bdb97d76feafec07607271aafa831b47c9b05c9c0f4155601c74a4edce07cf5b81827b94dc3596fbeacf489b7dfbd7",import.meta.url)],["pacman-test.obj",new URL("./files/596e5c910fe566aea1afd41cdc04b00dc589f27d52a73275f8290b017fb66aa0dda0b4e2a07dce4df68eeee22614d7c2ff2e49266d153d8f94cbc0373c112261",import.meta.url)],["ghost.obj",new URL("./files/32cde71d5a2e12b55f0e59a98c6188689f89c69f4a6c7492f4c78a4ce6c6d6f26e4fead849942bac8b64e09af1f53452c98bd3fbba086fe0be9cf3d732979a32",import.meta.url)],["banana.obj",new URL("./files/130b18e03afd66b4c3a1557fa5189284250efd25441bc7c0a8bdfad11101970daeeaaf912769371e0cce68324b4e03cff0666de8c475382840b3eb72b657b13b",import.meta.url)],["cherry.obj",new URL("./files/fbc54e7a2294ab9ab2da22a24a7ff6e479e8a22a67004407db1f7466b2137c53aee5de95ab589927573874f6519c9a45bacc76fb17286f5b84b2df3ae19ae4a7",import.meta.url)],["pacman layout@2.png",new URL("./files/52d68dca4fc8fafb5066c11c8ce82e2a2cc5cf1470cb01a7e9b53a6c3c04a6f21fe8c1f142ef34c41d04cf3b6385500c50a7cfcc15c3db8a7ef0978aa39f937f",import.meta.url)]]);
...
md`** Camera Adjustments **`
  ...
  main.variable(observer("viewof fov_Y")).define("viewof fov_Y", ["Inputs"], function(Inputs){return(
Inputs.range([1, 75], {
  value: 51,
  ...
  main.variable(observer("viewof lightParameters")).define("viewof lightParameters", ["columns","Inputs"], function(columns,Inputs){return(
columns({
  ...
  main.variable(observer("viewof wallHeight")).define("viewof wallHeight", ["Inputs"], function(Inputs){return(
Inputs.range([0, 2], {
    value: 1.0,
    label: "Wall height",
    step: 0.1
  ...
  main.variable(observer("viewof ambientLightIntensity")).define("viewof ambientLightIntensity", ["Inputs"], function(Inputs){return(
Inputs.range([0, 50], {
    value: 10,
    step: 5,
  ...
  main.variable(observer("viewof cameraAngles")).define("viewof cameraAngles", ["columns","Inputs"], function(columns,Inputs){return(
columns({
...
md`** Click here to start the game! **`
  ...
  main.variable(observer("viewof start")).define("viewof start", ["html"], function(html)
{
...
return button;
  ...
  main.variable(observer("viewof b2")).define("viewof b2", ["html","gameDivC","gl","gameOverlayEl","defaultWidth","defaultHeight","start"], function(html,gameDivC,gl,gameOverlayEl,defaultWidth,defaultHeight,start)
{
  ...
  main.variable(observer("gameEl")).define("gameEl", ["start","gameDivC","html"], function(start,gameDivC,html)
{
  if (start === 'true') {
...
md`To move use WASD, the arrow keys, or the joystick below.`
  ...
  main.variable(observer("joystick")).define("joystick", ["d3","width","height","joystickRadius","drag"], function(d3,width,height,joystickRadius,drag)
{
  ...
  main.variable(observer("game")).define("game", ["mazeDataTemplate","createKeyManager","joyStickInput","gameOverlayEl","resetVal","gl","hex2rgb","colors","renderer","renderSoreScene","scoreSceneProgramInfo","invalidation","start"], function(mazeDataTemplate,createKeyManager,joyStickInput,gameOverlayEl,resetVal,gl,hex2rgb,colors,renderer,renderSoreScene,scoreSceneProgramInfo,invalidation,start)
{
...
md`** Joystick Implementation and Methods **`
  ...
  main.variable(observer("joyStickInput")).define("joyStickInput", function(){return(
{direction: 'none'}
)});
  main.variable(observer("drag")).define("drag", ["d3","joyStickInput"], function(d3,joyStickInput)
{
  ...
  main.variable(observer("joystickRadius")).define("joystickRadius", function(){return(
1.5
)});
...
md`### Variables and Functions`
  ...
  main.define("initial resetVal", function(){return(
false
)});
  ...
  main.variable(observer("createKeyManager")).define("createKeyManager", function(){return(
...
md`### Pellets and power pellet (energizers)`
  ...
  main.variable(observer("pelletSphere")).define("pelletSphere", ["twgl","gl"], function(twgl,gl){return(
twgl.primitives.createSphereBufferInfo(gl, 0.15, 20, 20)
)});
  main.variable(observer("bigPelletSphere")).define("bigPelletSphere", ["twgl","gl"], function(twgl,gl){return(
twgl.primitives.createSphereBufferInfo(gl, 0.2, 20, 20)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`### Maze walls`
)});
  main.variable(observer("makeBox")).define("makeBox", ["makeQuad","mergeParts","transformVertices"], function(makeQuad,mergeParts,transformVertices){return(
...
const model = mergeParts(faces);
  ...
  main.variable(observer("wallBufferInfo")).define("wallBufferInfo", ["mazeDataTemplate","makeBox","mergeParts","twgl","gl"], function(mazeDataTemplate,makeBox,mergeParts,twgl,gl)
{ 
  const boxes = [];
...
md`Cherry`
  ...
  main.variable(observer("cherryURL")).define("cherryURL", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("cherry.obj").url()
)});
  main.variable(observer("cherryModel")).define("cherryModel", ["loadModelFromURL","cherryURL"], async function(loadModelFromURL,cherryURL){return(
await loadModelFromURL(cherryURL, "obj")
)});
  main.variable(observer("cherryVertexAttributes")).define("cherryVertexAttributes", ["cherryModel"], function(cherryModel){return(
cherryModel.map((d) => ({
  ...
  main.variable(observer("cherryBuffers")).define("cherryBuffers", ["cherryVertexAttributes","twgl","gl"], function(cherryVertexAttributes,twgl,gl){return(
cherryVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("cherryExtent")).define("cherryExtent", ["computeModelExtent","cherryModel"], function(computeModelExtent,cherryModel){return(
computeModelExtent(cherryModel)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`Banana`
)});
  main.variable(observer("bananaURL")).define("bananaURL", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("banana.obj").url()
)});
  main.variable(observer("bananaModel")).define("bananaModel", ["loadModelFromURL","bananaURL"], async function(loadModelFromURL,bananaURL){return(
await loadModelFromURL(bananaURL, "obj")
)});
  main.variable(observer("bananaVertexAttributes")).define("bananaVertexAttributes", ["bananaModel"], function(bananaModel){return(
bananaModel.map((d) => ({
  position: { numComponents: 3, data: d.sc.positions },
  normal: { numComponents: 3, data: d.sc.normals },
  uv: { numComponents: 2, data: d.sc.uvs }
  ...
  main.variable(observer("bananaBuffers")).define("bananaBuffers", ["bananaVertexAttributes","twgl","gl"], function(bananaVertexAttributes,twgl,gl){return(
bananaVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("bananaExtent")).define("bananaExtent", ["computeModelExtent","bananaModel"], function(computeModelExtent,bananaModel){return(
computeModelExtent(bananaModel)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`**Adding Pac-Man Model**`
)});
  main.variable(observer("pacmanUrl")).define("pacmanUrl", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("pacman-test.obj").url()
)});
  main.variable(observer("pacmanModel")).define("pacmanModel", ["loadModelFromURL","pacmanUrl"], async function(loadModelFromURL,pacmanUrl){return(
await loadModelFromURL(pacmanUrl, "obj")
)});
  main.variable(observer("pacmanVertexAttributes")).define("pacmanVertexAttributes", ["pacmanModel"], function(pacmanModel){return(
pacmanModel.map((d) => ({
  position: { numComponents: 3, data: d.sc.positions },
  normal: { numComponents: 3, data: d.sc.normals },
  uv: { numComponents: 2, data: d.sc.uvs }
  ...
  main.variable(observer("pacmanBuffers")).define("pacmanBuffers", ["pacmanVertexAttributes","twgl","gl"], function(pacmanVertexAttributes,twgl,gl){return(
pacmanVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("pacmanExtent")).define("pacmanExtent", ["computeModelExtent","pacmanModel"], function(computeModelExtent,pacmanModel){return(
computeModelExtent(pacmanModel)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`** Adding Clyde (Orange) **`
)});
  main.variable(observer("clydeURL")).define("clydeURL", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("ghost.obj").url()
)});
  main.variable(observer("clydeModel")).define("clydeModel", ["loadModelFromURL","clydeURL"], async function(loadModelFromURL,clydeURL){return(
await loadModelFromURL(clydeURL, "obj")
)});
  main.variable(observer("clydeVertexAttributes")).define("clydeVertexAttributes", ["clydeModel"], function(clydeModel){return(
clydeModel.map((d) => ({
  position: { numComponents: 3, data: d.sc.positions },
  normal: { numComponents: 3, data: d.sc.normals },
  uv: { numComponents: 2, data: d.sc.uvs }
  ...
  main.variable(observer("clydeBuffers")).define("clydeBuffers", ["clydeVertexAttributes","twgl","gl"], function(clydeVertexAttributes,twgl,gl){return(
clydeVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("clydeExtent")).define("clydeExtent", ["computeModelExtent","clydeModel"], function(computeModelExtent,clydeModel){return(
computeModelExtent(clydeModel)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`** Adding Inky (Blue) **`
)});
  main.variable(observer("inkyURL")).define("inkyURL", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("ghost.obj").url()
)});
  main.variable(observer("inkyModel")).define("inkyModel", ["loadModelFromURL","inkyURL"], async function(loadModelFromURL,inkyURL){return(
await loadModelFromURL(inkyURL, "obj")
)});
  main.variable(observer("inkyVertexAttributes")).define("inkyVertexAttributes", ["inkyModel"], function(inkyModel){return(
inkyModel.map((d) => ({
  position: { numComponents: 3, data: d.sc.positions },
  normal: { numComponents: 3, data: d.sc.normals },
  uv: { numComponents: 2, data: d.sc.uvs }
  ...
  main.variable(observer("inkyBuffers")).define("inkyBuffers", ["inkyVertexAttributes","twgl","gl"], function(inkyVertexAttributes,twgl,gl){return(
inkyVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("inkyExtent")).define("inkyExtent", ["computeModelExtent","inkyModel"], function(computeModelExtent,inkyModel){return(
computeModelExtent(inkyModel)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`** Adding Blinky (Red) **`
)});
  main.variable(observer("blinkyURL")).define("blinkyURL", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("ghost.obj").url()
)});
  main.variable(observer("blinkyModel")).define("blinkyModel", ["loadModelFromURL","blinkyURL"], async function(loadModelFromURL,blinkyURL){return(
await loadModelFromURL(blinkyURL, "obj")
)});
  main.variable(observer("blinkyVertexAttributes")).define("blinkyVertexAttributes", ["blinkyModel"], function(blinkyModel){return(
blinkyModel.map((d) => ({
  position: { numComponents: 3, data: d.sc.positions },
  normal: { numComponents: 3, data: d.sc.normals },
  uv: { numComponents: 2, data: d.sc.uvs }
  ...
  main.variable(observer("blinkyBuffers")).define("blinkyBuffers", ["blinkyVertexAttributes","twgl","gl"], function(blinkyVertexAttributes,twgl,gl){return(
blinkyVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("blinkyExtent")).define("blinkyExtent", ["computeModelExtent","blinkyModel"], function(computeModelExtent,blinkyModel){return(
computeModelExtent(blinkyModel)
)});
  main.variable(observer()).define(["md"], function(md){return(
md`** Adding Pinky (Pink, probably) **`
)});
  main.variable(observer("pinkyURL")).define("pinkyURL", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("ghost.obj").url()
)});
  main.variable(observer("pinkyModel")).define("pinkyModel", ["loadModelFromURL","pinkyURL"], async function(loadModelFromURL,pinkyURL){return(
await loadModelFromURL(pinkyURL, "obj")
)});
  main.variable(observer("pinkyVertexAttributes")).define("pinkyVertexAttributes", ["pinkyModel"], function(pinkyModel){return(
pinkyModel.map((d) => ({
  position: { numComponents: 3, data: d.sc.positions },
  normal: { numComponents: 3, data: d.sc.normals },
  uv: { numComponents: 2, data: d.sc.uvs }
  ...
  main.variable(observer("pinkyBuffers")).define("pinkyBuffers", ["pinkyVertexAttributes","twgl","gl"], function(pinkyVertexAttributes,twgl,gl){return(
pinkyVertexAttributes.map((vertexAttributes) => twgl.createBufferInfoFromArrays(gl, vertexAttributes))
)});
  main.variable(observer("pinkyExtent")).define("pinkyExtent", ["computeModelExtent","pinkyModel"], function(computeModelExtent,pinkyModel){return(
...
(aspect, gameState, shadow) => { 
  ...
  */
  ...
  main.variable(observer("findCellsOfType")).define("findCellsOfType", function(){return(
function findCellsOfType(mazeData, type) {
  ...
  main.variable(observer("defaultWidth")).define("defaultWidth", function(){return(
1150
)});
  main.variable(observer("defaultHeight")).define("defaultHeight", function(){return(
500
)});
  main.variable(observer("gl")).define("gl", ["DOM","defaultWidth","defaultHeight"], function(DOM,defaultWidth,defaultHeight)
{
  ...
  main.variable(observer("reset")).define("reset", ["html","mutable resetVal"], function(html,$0)
{
...
return res;
  ...
  main.variable(observer("gameDivC")).define("gameDivC", ["gl","gameOverlayEl"], function(gl,gameOverlayEl)
{
  ...
  main.variable(observer("gameOverlayEl")).define("gameOverlayEl", ["gl","reset"], function(gl,reset)
{
...
md`** Camera & Light**`
  ...
  main.variable(observer("near")).define("near", function(){return(
0.1
)});
  main.variable(observer("far")).define("far", function(){return(
2.5
)});
  main.variable(observer("cameraLookAt")).define("cameraLookAt", ["modelDim"], function(modelDim){return(
modelDim.center
)});
  main.variable(observer("radius")).define("radius", function(){return(
1
)});
  main.variable(observer("getViewMatrix")).define("getViewMatrix", ["m4","v3","cameraLookAt","modelDim"], function(m4,v3,cameraLookAt,modelDim){return(
(r, x_angle, y_angle) => {
  ...
  main.variable(observer("getProjectionMatrix")).define("getProjectionMatrix", ["m4","deg2rad","modelDim"], function(m4,deg2rad,modelDim){return(
({fov, near, far, aspect}) => {
  ...
  main.variable(observer("lightPosition")).define("lightPosition", ["lightParameters","modelDim","v3","lightDirection"], function(lightParameters,modelDim,v3,lightDirection)
{
  const D = (lightParameters.distanceFactor * modelDim.dia) / 2;
  return v3.add(modelDim.center, v3.mulScalar(lightDirection, D));
}
);
  main.variable(observer("lightDirection")).define("lightDirection", ["m4","deg2rad","lightParameters"], function(m4,deg2rad,lightParameters){return(
...
md`*** Life and Score ***`
  ...
  main.variable(observer("livesimg")).define("livesimg", ["FileAttachment"], function(FileAttachment){return(
FileAttachment("lives.jpg").url()
)});
  main.variable(observer("liveimg")).define("liveimg", ["FileAttachment"], function(FileAttachment){return(
...
FileAttachment("score.jpg").image()
  ...
  main.variable(observer("scoresimg")).define("scoresimg", ["FileAttachment"], function(FileAttachment){return(
FileAttachment("score.jpg").url()
)});
  main.variable(observer("texturl")).define("texturl", ["FileAttachment"], function(FileAttachment){return(
FileAttachment("text.png").url()
)});
  main.variable(observer("livetex")).define("livetex", ["twgl","gl","liveimg"], function(twgl,gl,liveimg){return(
twgl.createTexture(gl, {
  ...
  main.variable(observer("livestex")).define("livestex", ["twgl","gl","livesimg"], function(twgl,gl,livesimg){return(
twgl.createTexture(gl, {
  src: livesimg,
  //    target: gl.TEXTURE_2D,
  flipY: true
  ...
  main.variable(observer("scoretex")).define("scoretex", ["twgl","gl","scoresimg"], function(twgl,gl,scoresimg){return(
twgl.createTexture(gl, {
  src: scoresimg,
  //    target: gl.TEXTURE_2D,
  flipY: true
  ...
  main.variable(observer("makeText")).define("makeText", ["DOM"], function(DOM){return(
function makeText(text) {
  ...
  main.variable(observer("scoreSceneProgramInfo")).define("scoreSceneProgramInfo", ["errorBlock","twgl","gl"], function(errorBlock,twgl,gl)
{
  ...
  main.variable(observer("textbufferInfoArray")).define("textbufferInfoArray", ["textvertexAttributes","twgl","gl"], function(textvertexAttributes,twgl,gl){return(
textvertexAttributes.map((d) =>
  twgl.createBufferInfoFromArrays(gl, d)
)
)});
  main.variable(observer("textvertexAttributes")).define("textvertexAttributes", function(){return(
[
  {
    // Attribute position
  ...
  main.variable(observer("scoretextures")).define("scoretextures", ["makeText","twgl","gl"], function(makeText,twgl,gl){return(
function (msg) {
  ...
  main.variable(observer("renderSoreScene")).define("renderSoreScene", ["gl","m4","scoretex","textbufferInfoArray","twgl","scoretextures","livestex","livetex"], function(gl,m4,scoretex,textbufferInfoArray,twgl,scoretextures,livestex,livetex){return(
...
md`### Buffers`
  ...
  main.variable(observer("boxBufferInfo")).define("boxBufferInfo", ["twgl","gl"], function(twgl,gl)
{
  const boxAttributes = {
    position: [
      -1,
  ...
  main.variable(observer("modelDim")).define("modelDim", ["mazeDataTemplate"], function(mazeDataTemplate)
{
  ...
  main.variable(observer("lightBufferInfo")).define("lightBufferInfo", ["twgl","gl"], function(twgl,gl)
{
  ...
  main.variable(observer("setStencilingParameters")).define("setStencilingParameters", ["gl"], function(gl){return(
(ref) => {
  ...
  main.variable(observer("setMaskingParameters")).define("setMaskingParameters", ["gl"], function(gl){return(
(ref) => {
  // drawMask function from https://observablehq.com/@esperanc/stencil-buffer
  gl.enable(gl.STENCIL_TEST);
  gl.stencilFunc(
  ...
  main.variable(observer("setDefaultParameters")).define("setDefaultParameters", ["gl"], function(gl){return(
() => {
...
md`## Maze Structure`
  ...
  main.variable(observer("img")).define("img", ["FileAttachment"], async function(FileAttachment){return(
await FileAttachment("pacman layout@2.png").image()
)});
  main.variable(observer("viewof img3")).define("viewof img3", ["FileAttachment"], async function(FileAttachment)
{
  ...
  main.variable(observer("cellTypeColors")).define("cellTypeColors", ["cellTypes","hex2rgb"], function(cellTypes,hex2rgb)
{
  ...
  main.variable(observer("cellTypes")).define("cellTypes", function(){return(
{
    "57,49,223,255": "wall",
  ...
  main.variable(observer("mazeDataTemplate")).define("mazeDataTemplate", ["img","cellTypes"], function(img,cellTypes)
{
  ...
  main.variable(observer("makeQuad")).define("makeQuad", function(){return(
function makeQuad(p1, p2, p3, p4, normal) {
  ...
  main.variable(observer("ghostBarrierBufferInfo")).define("ghostBarrierBufferInfo", ["mazeDataTemplate","makeBox","wallHeight","mergeParts","twgl","gl"], function(mazeDataTemplate,makeBox,wallHeight,mergeParts,twgl,gl)
{
  const boxes = [];
  for (let x = 0; x < mazeDataTemplate.width; x++) {
    for (let y = 0; y < mazeDataTemplate.height; y++) {
  ...
  main.variable(observer("transformVertices")).define("transformVertices", function(){return(
function transformVertices(pos, x, y, z, scale) {
  ...
  main.variable(observer("mergeParts")).define("mergeParts", function(){return(
(faces) => {
  let indexOffset = 0;
  const position = [];
  const normal = [];
...
md`** Program Information **`
  ...
  main.variable(observer("boxProgramInfo")).define("boxProgramInfo", ["twgl","gl"], function(twgl,gl)
{
  const vs = `#version 300 es
  ...
  main.variable(observer("errorBlock")).define("errorBlock", ["html","width"], function(html,width){return(
html`<textarea style="height : 20px; width : ${width}px; font-size: 0.8em; display: block"></textarea>`
)});
  main.variable(observer("sceneProgramInfo")).define("sceneProgramInfo", ["errorBlock","twgl","gl"], function(errorBlock,twgl,gl)
{
  const shaders = {
    vs: `#version 300 es
    precision mediump float;
  ...
  main.variable(observer("normalProgramInfo")).define("normalProgramInfo", ["errorBlock","twgl","gl"], function(errorBlock,twgl,gl)
{
  const shaders = {
    vs: `#version 300 es
    precision mediump float;
...
md`** Miscellaneous **`
  ...
  main.variable(observer("viewof colors")).define("viewof colors", ["columns","color"], function(columns,color){return(
columns({
...
(deg) => (Math.PI * deg) / 180
  ...
  main.variable(observer("m4")).define("m4", ["twgl"], function(twgl){return(
twgl.m4
)});
  main.variable(observer("v3")).define("v3", ["twgl"], function(twgl){return(
twgl.v3
)});
